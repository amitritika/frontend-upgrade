...
import RightBlockHeading from "../../../../components/visualresume/expert/template5/resume/RightBlockHeading"
import RightBlockLogo from "../../../../components/visualresume/expert/template5/resume/RightBlockLogo"
import RightBlockProject from "../../../../components/visualresume/expert/template5/resume/RightBlockProject"
import BlockProject from "../../../../components/visualresume/expert/template5/resume/BlockProject"
import {textWidth, textWidthL} from "./template5";
...
const projectInfo = (obj, data, marginSec, marginBullet, marginPage) => {
  ...
  data.value.map((v, i)=>{
    ...
    let arrt = textWidth("calibri", "bold", "3.2pt", "113px", v.titile);
    let height = arrd[0] + arrt[0];
    if(countR > countL){
      arrd = textWidthL("calibri", "normal", "3.2pt", "183px", v.desc);
      arrt = textWidth("calibri", "bold", "3.2pt", "183px", v.titile);
    ...
    if(rightH > countR * 297){
      ...
      rightH = 297 * (countR -1) + marginPage;
        ...
        obj.page1.right.props = obj.right.props;
          ...
          arrt = textWidth("calibri", "bold", "3.2pt", "113px", v.titile);
          height = arrd[0] + arrt[0];
