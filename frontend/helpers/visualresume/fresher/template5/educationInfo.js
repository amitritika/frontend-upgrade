...
import RightBlockEdu from "../../../../components/visualresume/fresher/template5/resume/RightBlockEdu"
import BlockEdu from "../../../../components/visualresume/fresher/template5/resume/BlockEdu"
...
const educationInfo = (obj, data, marginSec, marginBullet, marginPage) => {
  ...
  data.value.map((v, i)=>{
    ...
    if(countR > countL){
      ...
      obj.right.props.push({top: rightH + marginSec, height: 12, data: v, line : line});
