import BlockHeading from "../../../../components/visualresume/expert/template5/resume/BlockHeading"
...
import RightBlockBulletSmall from "../../../../components/visualresume/fresher/template5/resume/RightBlockBulletSmall"
import BlockBulletSmall from "../../../../components/visualresume/fresher/template5/resume/BlockBulletSmall"
...
const extraInfo = (obj, data, marginSec, marginBullet, marginPage, logo) => {
  ...
  if(countR > countL){
    ...
    obj.block.props.push({top: rightH + marginSec, name: FaAward});
    ...
    obj.right.props.push({top: rightH + marginSec, name: FaAward});
...
//     }
  ...
  data.value.map((v, i)=>{
    ...
    if(rightH > countR * 297){
      countR++;
      obj.right.props[obj.right.props.length-2].line = false
      rightH = 297 * (countR -1) + marginPage;
        if(countR > countL) {
          if(countR - 1 == countL){
            obj.right.components.pop();
